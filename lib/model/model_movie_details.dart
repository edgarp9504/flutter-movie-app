...
//
//     final modelMovieDetails = modelMovieDetailsFromMap(jsonString);

import 'dart:convert';

class ModelMovieDetails {
  ModelMovieDetails({
    required this.adult,
  ...
  factory ModelMovieDetails.fromJson(String str) =>
      ModelMovieDetails.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory ModelMovieDetails.fromMap(Map<String, dynamic> json) =>
      ModelMovieDetails(
        adult: json["adult"],
